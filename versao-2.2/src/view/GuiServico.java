    ...
    public void definirEventos() {
        ...
        btSalvar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    // Tratamento do ID
                    if (tfIdServico.getText().trim().isEmpty()) {
                        servico.setIdServico(0);
                    } else {
                        servico.setIdServico(Integer.parseInt(tfIdServico.getText().trim()));
                    }
                    ...
                    JOptionPane.showMessageDialog(btSalvar, "Erro ao salvar: " + ex.getMessage());
                }
            }
        });
